...
const CreatePost = () => {
    ...
    const handleSubmit = async () => {
        ...
        const postType = images.lengthlength && content ? 'text_with_image' : images.length ? 'image' : 'text'
        ...
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
            <div className='max-w-6xl mx-auto p-6'>
                <div className="mb-8">
                    ...
                    <p className="text-slate-600">Share your thoughts with your world</p>
                </div>
                ...
                <div className="max-w-xl bg-white p-4 sm:p-8 sm:pb-3 rounded-xl shadow-md space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-3 border-t border-gray-300">
                        ...
                        <input type='file' d='images' accept='image/*' hidden multiple
                        onChange={(e) => setImages([...images, ...e.target.files])}/>

                        <button disabled={loading} onClick={() => toast.promise(
                            handleSubmit(),{
                                loading: 'uploading...',
                                success: <p>Post Aadded</p>,
