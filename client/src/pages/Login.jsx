        ...
        <div className="min-h-screen flex flex-col md:flex-row">
            ...
            <div className="flex-1 flex flex-col items-start justify-between p-6 md:p-10 lg:pl-40">
                ...
                <div>
                    ...
                    <p className="text-xl md:text-3xl text-indigo-900 max-w-72 md:max-w-md">connect with global community on our social</p>
                </div>
                <span className="md:h-10"></span>
            </div>

            <div className="flex-1 flex items-center jusify-center p-6 sm:p-10">
                <SignIn/>
            </div>
        </div>
    )
