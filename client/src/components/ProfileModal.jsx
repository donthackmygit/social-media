            ...
            <div className="max-w-2xl sm:py-6 mx-auto">
                <div className="bg-white rounded-lg shadow p-6">
                    ...
                    <form className="space-y-4" onSubmit={handleSaveProfile}>
                        ...
                        <div className="flex flex-col items-start gap-3">
                            <label htmlFor='corver_photo' className="block text-sm font-medium text-gray-700 mb-1">
                                Cover Photo
                                <input hidden type='file' accept='image/*' id="profile_picture"
                                    className="w-full p-3 border border-gray-200 rounded-lg"
                                    onChange={(e) => setEditForm({ ...editForm, profile_picture: e.target.files[0] })} />
                        ...
                        <div>
                            <label className="block text-sm font0-medium text-gray-700 mb-1">
                                Name
                            </label>
                        ...
                        <div>
                            ...
                            <input type='text' className="w-full p-3 border border-gray-200 rounded-lg" placeholder="Please enter an username" onChange={(e) => setEditForm({ ...editForm, username: e.target.value })} value={editForm.username} />
                        </div>
                        ...
                        <div className="flex justify-end space-x-3 pt-6">
                            ...
                            <button className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition cursor-pointer">Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
