...
import User from "../models/User.js";
import fs from 'fs';
// Sửa lỗi: Import trực tiếp hàm khởi tạo, không phải instance
import getImageKitInstance from '../configs/imageKit.js'; 
import Connection from '../models/Connection.js';
...
export const updateUserData = async (req, res) => {
    try {
        ...
        // Khởi tạo ImageKit instance ngay tại đây, trong hàm xử lý request
